...
//return sourceMatchArray + ":"+translationMatchArray
  ...
  if(extraNumbersSource.length==0){
      result.message = 'The translate text have some extra numbers. Extra numbers in translate: '+extraNumbersTranslate;
      result.fixes = []
      return result;
      ...
      result.message = 'The translate text have some extra numbers, and some missing numbers. Extra numbers in translate: '+extraNumbersTranslate+'. Missing numbers in translation: '+extraNumbersSource;
      result.fixes = []
      return result;
    }
